                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3 flex-1 min-w-0">
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center justify-between">
                              <p className={`text-sm truncate ${email.status === "unread" ? "font-semibold" : ""}`}>
                                {email.fromName}
                              </p>
                              <div className="flex items-center space-x-2">
                            ...
                            <p className={`text-sm truncate ${email.status === "unread" ? "font-medium" : "text-muted-foreground"}`}>
                              {email.subject}
                            </p>
                            ...
                            <div className="flex items-center space-x-2 mt-2">
                              ...
                              {email.hasAttachment && <Badge variant="outline" className="text-xs">📎 Attachment</Badge>}
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="border rounded-lg p-4">
                        ...
                        <div className="prose max-w-none">
                          ...
                          <p>Best regards,<br/>{email.fromName}</p>
                        </div>
                      </div>
                      ...
                      {email.aiStatus === "responded" && (
                        <div className="border rounded-lg p-4 bg-green-50/50">
                          ...
                          <div className="prose max-w-none">
                            ...
                            <p>We can confirm the proposed maintenance window on Friday, February 16th, from 22:00 to 02:00 CET. This timing should minimize any impact on your operations.</p>
                            <p>We will send you a reminder 24 hours before the maintenance begins, along with detailed information about what to expect during this period.</p>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                              <Label htmlFor="approve-response" className="text-sm">Approve this response</Label>
